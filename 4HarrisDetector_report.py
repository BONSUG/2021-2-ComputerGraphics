...
def calc_derivatives(src):
    ...
    Ix = my_filtering(src,x)
    Iy = my_filtering(src,y)
    return Ix, Iy
...
def HarrisDetector(src, gaus_filter_size = 3, gaus_sigma = 1, alpha = 0.04, threshold_rate = 0.01):
    ...
    cv2.imshow('201904237 - dst_x_Norm', dst_x_Norm)
    cv2.imshow('201904237 - dst_y_Norm', dst_y_Norm)
    cv2.waitKey()
    ...
    cv2.imshow('201904237 - IxIx', IxIx)
    cv2.imshow('201904237 - IyIy', IyIy)
    #cv2.imshow('IxIy', IxIy)
    cv2.imshow('201904237 - dst_IxIy_Norm', dst_IxIy_Norm)
    cv2.waitKey()
    ...
    cv2.imshow('201904237 - G_IxIx', G_IxIx)
    cv2.imshow('201904237 - G_IyIy', G_IyIy)
    #cv2.imshow('G_IxIy', G_IxIy)
    cv2.imshow('201904237 - G_dst_IxIy_Norm', G_dst_IxIy_Norm)
    cv2.waitKey()
    ...
    cv2.imshow('201904237 - har before threshold', G_dst_har_Norm)
    ...
    cv2.imshow('201904237 - har after threshold', G_dst_har_thresh_Norm)
...
def main():
    ...
    cv2.imshow('201904237 - original', src)
    ...
    cv2.imshow('201904237 - interest points', interest_points)
    cv2.imshow('201904237 - harris_img', harris_img)
    cv2.waitKey()
